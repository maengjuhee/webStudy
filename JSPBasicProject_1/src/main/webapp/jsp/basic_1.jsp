...
<%-- 
      ...
      Back-End : Java , JSP , Sevlet , Spring , Oracle
                 ====                           ======
      ...
      JSP
        ...
        3. 지시자
           page : JSP 파일에 대한 정보를 저장
                  ...
                  = 에러 페이지 : errorPage="파일명"
                    ...
                    4) 412 : 한글 변환 코드 문제 발생 (UTF-8 => UFT-8)
        ...
        a.jsp     => class a_jsp extends HTTPServlet
                     {
                        <%! %>
                        public_void _jspInit
                        {
                        }
                        public void _jspDestory
                        {
                        }
                        // JSP에서 코딩하는 영역 => 메소드 안 들어가는 내용
        ...
        1) 웹 동작
           ...
           요청시 => URL주소를 이용한다
             ...
             ================ =================================
               ...
               *** 파일이 확장자는 개발자가 설정할 수 있다
                   .naver / .daum / .do
                   PathVariable => 가장 사용 (파일명, 변수값)
                   /amdin/1234 => Spring.Vue/React
         ...
         19page
            ...
            브라우저(클라이언트) : 크롬 / IE / FF
            웹서버 : Apache / IIS
            웹어플리케이션 / WAS : tomcat => JSP를 자바로 변경 => 브라우저 HTML를 전송
