...
<%--
       자바스크립트 : HTML과 CSS로 구성된 웹페이지를 동적으로 만들어주는 언어 
                 =========== 정적페이지 
          | 서버와 관련없이 브라우저에서 동적으로 변경 => 이미지변경 / 이벤트 발생 
          | 프론트 개발의 대표적인 프로그램 
            ...
            ========= 데이터를 저장 / 관리 / 제어 / 연산 
                      =========       ===== ====
                                            ...
                                            2) 이항연산자
                                               ...
                                               비교연산자 : ===(같다) , !==(같지않다)
                                                        ...
                                                        <= (작거나 같다) , >=(크거나 같다)
                                                        => 결과값은 true/false
                                                        => 숫자외에 문자열 , 날짜를 비교가 할 수 있다
                                               논리연산자 : && , ||
                                                             ===
                                                             둘중에 한개 이상만 true일때 true 
                                      ...
                                      3) 반복 제어
                                         반복문 종료 => break
                               ## 자바스크립트 : 자바 데이터를 받아서 HTML/CSS를 제어 => 동적페이지
                               ## HTML / CSS : 화면에만 출력 
                               ## 자바 : 오라클 데이터를 관리
              ...
              ==========================================
                ***document.getElementById(id명) 
                ...
                doucment.getElemeneByClassName(class명)
