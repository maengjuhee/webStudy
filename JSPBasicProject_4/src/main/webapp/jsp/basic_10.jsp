  ...
  <table class="table-content">
   <tr>
      ...
      ***JSP에서 사용하고 있는 HTML은 => out.write가 생략이 되어 있다
                                  =========
                                   들어가 있는 내용이 브라우저에 출력이 된다ㄴ
      public class basic_10_jsp extends HttpJspBase
      {
         &lt;%!  %&gt; => 선언된 내용 클래스 멤버로 사용
         =====================================
         public void _jspInit(){} => web.xml에 설정시 읽어간다
         public void _jspDestoy(){} => 화면이동, 새로고침 => 메모리 회수
         =====================================
         public void _jspServeice()
         {
            &lt;% %&gt; => 영역에 소스
            &lt;= &gt; => out.print()
         }
   ...
   <tr>
     ...
     <td width="50%">일반 자바소스(메소드호출 , 제어문, 연산자, 지역변수 선언):_jspService()안서 첨부하기</td>
   </tr>
   <tr>
     <th width="20%">&lt;% %&gt;</th>
     <td width="30%">표현식</td>
