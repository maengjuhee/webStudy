...
window.onload=()=>{
	// http://localhost:8080/JavaScriptProject_3/js/food_find_js.do
		...
		let pages='<a href="#" class="btn btn-sm btn-danger">이전</a>'
...
function detail(fno)
{
    axiox.get("http://localhost:8080/JavaScriptProject_3/js/food_detail_js.do",{
    	params:{
    		fno:fno
    	}
    	...
    	document.querySelector('#image').innerHTML=dd.image
    })
}
</script>
</head>
